...
//
export interface EntityInterface<T, K> {
    id: string;
    type?: T;
    kind?: K;
    name?: string;
 ...
 */
export const createDayDescriptor = (input: Date | null | undefined, partial: Record<string, any> = {}): any | null => {
    if (!input) return null;
 ...
 */
export const computeTimelineOrderInsideOfDay = (item: EntityInterface<any, any>, dayDesc?: any | null): number | null => {
