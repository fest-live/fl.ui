...
import {
    ...
    darkTheme,
    lightTheme
} from "../../../../../../apps/CrossWord/src/frontend/shared/routing/registry";
import type { ShellId, ViewId, Shell, ShellTheme } from "../../../../../../apps/CrossWord/src/frontend/shells/types";
...
import { isEnabledView, pickEnabledView } from "../../../../../../apps/CrossWord/src/frontend/shared/routing/views";

import { initializeLayers } from "../../../../../../apps/CrossWord/src/frontend/shared/routing/layer-manager";
...
export async function bootContent(
    ...
    return bootBase(container, view);
}
