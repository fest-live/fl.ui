...
export function SpeedDial(makeView: any) {
    ...
    const renderIconItem = (item: SpeedDialItem)=>{
        return H`<div data-shape=${tileShapeForItem(item)} class="ui-ws-item shaped ui-ws-item-icon" data-speed-dial-item data-layer="icons" ref=${(el) => attachItemNode(item, el as HTMLElement, true, makeView)}>
